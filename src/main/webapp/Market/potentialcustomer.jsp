                        ...
                        <form action="${pageContext.request.contextPath}/Market/SavePotentialCustomer" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 cell FormPadding"><input type="text"
                                            class=" form-control cellFrom" name="department" value="${bean.department}"
                                            maxlength="20">
                                    </div>

                                    <div class="col-md-1"></div>
                                    <div class="col-md-1 cell" style="font-size: 14px;">創造時間</div>
                                    <div class="col-md-2 cell FormPadding">
                                        ${bean.contacttime}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 cell FormPadding"><input type="number"
                                            class=" form-control cellFrom" name="companynum" value="${bean.companynum}"
                                            maxlength="20"></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 cell FormPadding"><input type="text"
                                            class=" form-control cellFrom" name="fromactivity"
                                            value="${bean.fromactivity}" maxlength="50">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 cell FormPadding">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 cell FormPadding">
                                        <textarea class="form-control " id="validationTextarea" name="remark" rows="5"
