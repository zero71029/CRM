                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 cellz FormPadding"><input type="text"
                                                                           class=" form-control cellFrom"
                                                                           name="department"
                                                                           v-model.trim="customer.department"
                                                                           maxlength="20">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 cellz FormPadding">
                                <div class="input-group ppp">
                                    <input type="text" class="form-control ppp"  name="phone" v-model.trim=" customer.phone" maxlength="20"
                                    >
                                    <span class="input-group-text">-</span>
                                    <input type="text" class="form-control" name="extension" placeholder="分機" maxlength="10"  v-model.trim="customer.extension"
                                    >
                                </div>
                            ...
                            <div class="col-md-3 cellz FormPadding"><input type="text"
                                                                           v-model.trim="customer.companynum"
                                                                           class=" form-control cellFrom"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 cellz FormPadding">
                                ...
                                <el-input type="textarea" v-model.trim="customer.remark" rows="5"
                                          id="remark" maxlength="200" show-word-limit name="remark">
