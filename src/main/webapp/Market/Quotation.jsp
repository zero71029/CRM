                        ...
                        <form action="${pageContext.request.contextPath}/CRM/SaveQuotation" method="post" id="myform"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 cell FormPadding">
                                    <textarea name="remark" id="message" maxlength="450"
                                    ...
                                    <c:forEach varStatus="loop" begin="0" end="${bean.qdb.size()-1}" items="${bean.qdb}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6  row">
                                                ...
                                                <input type="hidden" name="qdb[${loop.index}].quotationid"
                                                    value="${s.quotationid}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6  row">
                                        ...
                                        <div class="col-md-2 "><input type="number"
                                                name="qdb[${bean.qdb.size()==null?0:bean.qdb.size()}].price">
                                        </div>
                                        <div class="col-md-2 "><input type="number"
                                                name="qdb[${bean.qdb.size()==null?0:bean.qdb.size()}].num">
                                        </div>
                                        <div class="col-md-2 "><input type="number"
                                                name="qdb[${bean.qdb.size()==null?0:bean.qdb.size()}].total">
                                        </div>
                                    </div>
