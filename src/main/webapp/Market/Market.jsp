    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <div class="cat">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="catin">
            </div>
            </div>
            </div>
            <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <br>
                        <form action="${pageContext.request.contextPath}/Market/SaveMarket" method="post" class="basefrom g-3 needs-validation AAA">

                            <div class="row">
                                <input type="hidden" name="marketid" value="${bean.marketid}">
                                <div class="row" style="text-align: center;">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-6" style="background-color: rgb(102, 102, 102);font-size: 1.5rem;color: white;border-radius: 5px 5px 0 0 ;">
                                        基本資料</div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 FormPadding">
                                        <input type="text" class=" form-control cellFrom" name="name" style="width: 100%;" value="${bean.name}" maxlength="20" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class="col-md-4 form-control cellFrom client" name="client" list="company" value="${bean.client}" maxlength="20" required>
                                        <datalist id="company">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class=" form-control cellFrom col-md-4" name="contactname" value="${bean.contactname}" maxlength="20" readonly onclick="contact()">
                                    </div>
                                    <div class="col-md-1 "> </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class="col-md- form-control cellFrom" name="phone" value="${bean.phone}" maxlength="20">
                                    </div>
                                    <div class="col-md-1 cell">聯絡人電話</div>
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class="col-md- form-control cellFrom" name="contactphone" value="${bean.contactphone}" maxlength="19">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class=" form-control cellFrom" name="contactmoblie" value="${bean.contactmoblie}" maxlength="20">
                                    </div>
                                    <div class="col-md-1"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <select class="form-select cellFrom" name="source">
                                            ...
                                            <option value="研討會 - 合作夥伴" class="selItemOff" ${bean.source=="研討會 - 合作夥伴"
                                                ?"selected":null}>研討會 - 合作夥伴
                                            </option>
                                            <option value="廣告" class="selItemOff" ${bean.source=="廣告" ?"selected":null}>
                                                廣告
                                            </option>
                                            <option value="參展" class="selItemOff" ${bean.source=="參展" ?"selected":null}>
                                                參展
                                            </option>
                                            <option value="網絡" class="selItemOff" ${bean.source=="網絡" ?"selected":null}>
                                                網絡
                                            </option>
                                            <option value="口碑" class="selItemOff" ${bean.source=="口碑" ?"selected":null}>
                                                口碑
                                            </option>
                                            <option value="其他" class="selItemOff" ${bean.source=="其他" ?"selected":null}>
                                                其他
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class="col-md- form-control cellFrom" name="contactemail" value="${bean.contactemail}" maxlength="50">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class=" form-control cellFrom" name="product" value="${bean.product}" maxlength="20">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="number" class=" form-control cellFrom" name="cost" value="${bean.cost}" maxlength="30">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class="  form-control cellFrom CreateTime" name="createtime" readonly value="${bean.createtime}">
                                    </div>
                                    <div class="col-md-1 cell">結束時間</div>
                                    <div class="col-md-2 FormPadding">
                                        <input type="text" class=" form-control cellFrom EndTime" name="endtime" value="${bean.endtime}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 FormPadding">
                                        <textarea name="message" class="col-md-12" id="message" maxlength="9000" style=" height:75px;" required>${bean.message}</textarea>
                                    </div><br><br>
                                </div>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-6 FormPadding">
                                        <button type="submit" style="width: 100%;" class="btn btn-primary" onclick="return window.confirm('確定修改')">儲存</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <!-- ///////////////////////////////////////////////////////////////////////////// -->
                        <hr>
                        <form action="${pageContext.request.contextPath}/Market/SaveRemark" method="post" class="row g-3 needs-validation" novalidate>
                            <div class="row">
                                <input type="hidden" name="marketid" value="${bean.marketid}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 FormPadding">
                                        ...
                                        <textarea class="form-control" id="validationTextarea" required name="remark" rows="5" maxlength="200"></textarea>
                        ...
                        <c:if test="${not empty bean.mrb}">
                            <c:forEach varStatus="loop" begin="0" end="${bean.mrb.size()-1}" items="${bean.mrb}" var="s">
                                <div class="row">
                                    <div class="col-md-1"></div>
