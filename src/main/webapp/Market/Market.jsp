                    ...
                    <form action="${pageContext.request.contextPath}/Market/SaveMarket" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <%-- <ol class="breadcrumb">--%>
                                <%-- <li class="breadcrumb-item ">尚未處理{{stateNum}}</li>--%>
                                <%-- <li class="breadcrumb-item " v-show="stateNum >1 ">內部詢價中
                                    </li>--%>
                                <%-- <li class="breadcrumb-item " v-show="stateNum >2 ">
                                    報價處理中</li>--%>
                                <%-- <li class="breadcrumb-item " v-show="stateNum >3 ">
                                    已報價</li>--%>

                                <%-- <li class="breadcrumb-item "
                                    v-show="stateNum <4">--%>
                                <%-- <el-button type="text" @click="nextState">
                                    下一步</el-button>--%>
                                <%-- </li>--%>
                                <%-- <li class="breadcrumb-item "
                                    v-show="stateNum ==4 ">--%>
                                <%-- <el-button type="text"
                                    @click="nextState">提交主管
                                    </el-button>--%>

                                <%-- <el-button type="text"
                                    @click="nextState">成功結案
                                    </el-button>--%>
                                <%-- </li>--%>
                                <%-- <li
                                ...
                                <div class="row"
                                    ...
                                    <div
                                            class="col-md-2 cellz">
                                        創建時間
                                    </div>
                                    <div
                                            class="col-md-4 FormPadding">
                                        {{bean.aaa}}
                                    </div>
                                </div>
                                <div
                                ...
                                <div
                                    ...
                                    <div
                                            class="col-md-6 FormPadding">
                                        報價內容
                                        <div v-html="quoteHeight"
                                             id="quoteHeight"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 FormPadding">
                                <select name="producttype" id="Product_Type" v-model="bean.producttype"
                                    ...
                                    <%-- 大型顯示器--%>
                                    <%-- </option>--%>
                                    <%-- <option ${bean.producttype=="空氣品質" ?"selected":null}
                                        value="空氣品質">--%>
                                    <%-- 空氣品質--%>
                                    <%-- </option>--%>
                                    <%-- <option ${bean.producttype=="流量-AICHI"
                                        ?"selected":null}--%>
                                    <%-- value="流量-AICHI">--%>
                                    <%-- 流量-AICHI--%>
                                    <%-- </option>--%>
                                    <%-- <option
                                        ${bean.producttype=="流量-RGL"
                                        ?"selected":null}
                                        value="流量-RGL">--%>
                                    <%-- 流量-RGL--%>
                                    <%-- </option>--%>
                                    <%-- <option
                                        ${bean.producttype=="流量-Siargo"
                                        ?"selected":null}--%>
                                    <%--
                                        value="流量-Siargo">
                                        --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 FormPadding">
                                <c:if test="${user.position != '職員' }">
                                    <el-date-picker v-model="bean.endtime" align="right" type="date" name="endtime"
                ...
                <div class="col-md-11">
                    ...
                    <div class="row replyA" style="font-size: 12;">
                        ...
                        <div class="col-md-3 ccc" style="text-align: right;">
                            ...
                            <el-button v-show="s.remark == '${user.name}'" type="text" @click="removeTrack(s)">
                                刪除
                            </el-button>&nbsp;&nbsp;&nbsp;
