                    ...
                    <form action="${pageContext.request.contextPath}/Market/SaveMarket" method="post"
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 FormPadding">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="source"
                                               maxlength="90"
                                               name="source" v-model.trim="bean.source" list="sourceList">
                            ...
                            <div class="col-md-6">
                                ...
                                <%--                                                <li class="breadcrumb-item " v-show="stateNum >1 ">內部詢價中</li>--%>
                                <%--                                                <li class="breadcrumb-item " v-show="stateNum >2 ">報價處理中</li>--%>
                                <%--                                                <li class="breadcrumb-item " v-show="stateNum >3 ">已報價</li>--%>

                                <%--                                                <li class="breadcrumb-item " v-show="stateNum <4">--%>
                                <%--                                                    <el-button type="text" @click="nextState">下一步</el-button>--%>
                                <%--                                                </li>--%>
                                <%--                                                <li class="breadcrumb-item " v-show="stateNum ==4 ">--%>
                                <%--                                                    <el-button type="text" @click="nextState">提交主管</el-button>--%>

                                <%--                                                    <el-button type="text" @click="nextState">成功結案</el-button>--%>
                                <%--                                                </li>--%>
                                <%--                                                <li class="breadcrumb-item " v-show="stateNum ==5 ">--%>
                                <%--                                                    <el-button type="text" @click="nextState">提交主管</el-button>--%>
                                ...
                                <div class="row" style="height: 38px">
                                    ...
                                    <c:if test="${user.position != '職員' }">
                                        ...
                                        <div class="col-md-5" v-show="bean.stage  =='提交主管'">
                                            <el-button size="mini" type="primary" @click="BosOperate('已報價')">撤回
                                            </el-button>
                                            <el-button size="mini" type="primary" @click="BosOperate('失敗結案')">失敗結案
                                            </el-button>
                                        </div>
                                    </c:if>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 FormPadding">報價內容
                                        <div v-html="quoteHeight" id="quoteHeight"
                                             style="visibility: hidden ; position: absolute;z-index: -1;width: 312px;"></div>
