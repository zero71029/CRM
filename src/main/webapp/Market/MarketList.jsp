                    ...
                    <div class="col-md-11 app" v-cloak>
                        ...
                        <div class="row">
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                ...
                                <label class="btn btn-outline-primary" data-bs-toggle="offcanvas"
                                    data-bs-target="#StateSetSlider" id="StateSet"><i
                        ...
                        <div class="row" style="border-bottom: #0a53be 1px solid">
                            <div class="col-lg-12">
                                <el-tag style="margin: 5px" v-for="tag in MarketStateList" key="tag.marketstateid"
                                    closable :disable-transitions="false" @close="CloseMarketState(tag)"
                                    :type="tag.type">
                                    {{tag.state}}
                                </el-tag>
                            </div>
                        ...
                        <div class="offcanvas offcanvas-end " tabindex="0" id="offcanvasRight" style="width: 450px;">
                            ...
                            <div class="offcanvas-body">
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <el-checkbox v-model="AutoClose">自動結案</el-checkbox>
                        ...
                        <!-- 狀態滑塊 -->
                        <div class="offcanvas offcanvas-end " tabindex="0" id="StateSetSlider" style="width: 450px;">
                            <div class="offcanvas-header">
                                <h5>狀態</h5>
                            ...
                            <div class="offcanvas-body">
                                <div class="accordion accordion-flush">
                                    ...
                                    <div>
                                        ...
                                        <div style="float: left;margin: 3px;">
                                            <el-button type="info" size="mini" plain
                                                @click="AddState('state','提交主管','info')" icon="el-icon-s-goods">提交主管
                                            </el-button>
                                        </div>
                                        <div style="float: left;margin: 3px;">
                                            <el-button type="info" size="mini" plain
                                                @click="AddState('state','成功結案','info')" icon="el-icon-s-goods">成功結案
                                            </el-button>
                                        </div>
                                        <div style="float: left;margin: 3px;">
                                            <el-button type="info" size="mini" plain
