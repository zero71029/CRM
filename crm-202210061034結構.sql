...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='新進⼈員帳號申請表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=682 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `businesstrip` (
  ...
  `createtime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`tripid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='出差申請';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `businesstripcooperator`
--

DROP TABLE IF EXISTS `businesstripcooperator`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `businesstripcooperator` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `tripid` int unsigned DEFAULT NULL,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `calender` (
  `calenderid` int unsigned NOT NULL AUTO_INCREMENT,
  `theme` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '主題',
  `detail` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '細節',
  `day` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '細節',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3635 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4447 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evaluatetask` (
  ...
  PRIMARY KEY (`taskid`)
) ENGINE=InnoDB AUTO_INCREMENT=45065 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-06 10:34:52
